...
- Expect to see some alerts triggered from WAN interface now and then as a result of everyday scanning and probing - legal and illegal. Run a "whois IP" command in your shell or equivalent to find out more about the scanner. Luckily, it's possible to request the removal of your IP address from some of those legit ones, for example: https://www.recyber.net/opt-out
